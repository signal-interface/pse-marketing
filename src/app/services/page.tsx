...
const services = [
  {
    ...
    features: [
      ...
      'Automated deposit scheduling (IRC §6656)',
  ...
  },
  {
    ...
    body: 'When regulations change, your compliance rules update the same day. Multi-state tax filing, withholding reconciliation, and regulatory monitoring across all active jurisdictions — without a compliance team.',
    features: [
      'Automated federal + state + local filing',
  ...
  },
  {
    ...
    body: 'Deduction reconciliation, enrollment sync, and benefits data validation — connected directly to payroll. No more manual exports between your benefits platform and payroll system.',
    features: [
      'Direct deduction sync',
      'Enrollment change automation',
      'ACA compliance tracking',
      'FSA/HSA deduction validation',
      'Benefits audit trail',
    ],
    stat: { value: '0', label: 'Manual reconciliation steps between benefits and payroll' },
  },
  {
